...
site1 = launch_sites_df['Launch Site'].iloc[0]
site2 = launch_sites_df['Launch Site'].iloc[1]
site3 = launch_sites_df['Launch Site'].iloc[2]
site4 = launch_sites_df['Launch Site'].iloc[3]
